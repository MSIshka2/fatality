...
local newFrame = imgui.OnFrame(
    ...
    function(player)
        ...
        imgui.Begin('##ScoreBoard', renderWindow, imgui.WindowFlags.NoCollapse + imgui.WindowFlags.NoResize + imgui.WindowFlags.NoTitleBar + imgui.WindowFlags.NoScrollWithMouse + imgui.WindowFlags.NoScrollbar)
